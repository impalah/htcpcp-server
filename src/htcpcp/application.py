...
from htcpcp.core.middleware import TraceIDMiddleware
from htcpcp.core.settings import settings

# from htcpcp.di import include_di
from htcpcp.exception_handlers import (
    general_exception_handler,
    http_exception_handler,
    validation_exception_handler,
)
from htcpcp.lifespan import lifespan
from htcpcp.routes import include_routers
